  ...
  if (@$_POST['register']) {
    ...
    if (empty($errors)) {
      ...
      // else{
        ...
        $searchName = $_SESSION["registerSearchName"];
        $price = $_SESSION["registerPrice"];
        $stock = $_SESSION["registerStock"];
        $comment = $_SESSION["registerComment"];
...
<div class="base">
  ...
  <form enctype="multipart/form-data" action="goodsRegisterForPicture.php" method="post">
    <!-- <p>
      商品名<br>
